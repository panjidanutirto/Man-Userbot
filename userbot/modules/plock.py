# Copyright © 2021 Catuserbot
# PORT BY @Vckyouuu / For FromVT-UserBot / @VckyouuBitch
# BASED ON PLUGINS
...
async def _(event):
    ...
    man = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
    ...
    if input_str == "msg":
        if msg:
            return await event.edit(
                "`This Group is already locked with messaging permission.`"
            )
        if umsg:
            return await event.edit(
                "`This User is already locked with messaging permission.`"
            )
        umsg = True
        locktype = "messages"
        ...
        if sticker:
            return await event.edit(
                "`This group is already locked with sending stickers`"
            )
        if usticker:
            return await event.edit(
                "`This user is already locked with sending stickers`"
            )
        usticker = True
        locktype = "stickers"
        ...
        if embed_link:
            return await event.edit(
                "`This group is already locked with previewing links`"
            )
        if uembed_link:
            return await event.edit(
                "`This group is already locked with previewing links`"
        ...
        if ainline:
            return await event.edit(
                "`This group is already locked with using inline bots`"
            )
        if uainline:
            return await event.edit(
                "`This user is already locked with using inline bots`"
            )
        uainline = True
        ...
        if adduser:
            return await event.edit(
                "`This group is already locked with adding members`"
            )
        if uadduser:
...
async def _(event):
    ...
    if input_str == "msg":
        ...
        if not usticker:
            return await event.edit(
                "`This user is already unlocked with sending stickers`"
            )
        usticker = False
        locktype = "stickers"
    elif input_str == "preview":
        ...
        if not uembed_link:
            return await event.edit(
                "`This user is already unlocked with previewing links`"
            )
        uembed_link = False
        locktype = "preview links"
    elif input_str == "gif":
        ...
        if not ugamee:
            return await event.edit(
                "`This user is already unlocked with sending games`"
            )
        ugamee = False
        locktype = "games"
    elif input_str == "inline":
        ...
        if not ugpoll:
            return await event.edit(
                "`This user is already unlocked with sending polls`"
            )
        ugpoll = False
        locktype = "polls"
    elif input_str == "invite":
        ...
        if not uadduser:
            return await event.edit(
                "`This user is already unlocked with adding members`"
            )
        uadduser = False
        locktype = "invites"
    elif input_str == "pin":
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Contoh :** `.plock msg` atau `.unplock msg`\
    "
    }
)
